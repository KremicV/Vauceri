 ...
 * @author vlada
 */
public class Evidentiraj extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Evidentiraj</title>");            
            out.println("</head>");
            out.println("<body>");
                ...
                //konekcija sa bazom
                   ...
                   //Provera da li broj vaucera vec postoji u bazi
                    ...
                    if(broj==0){
                        ...
                        String upit = "UPDATE vaucer SET Status='Iskoriscen' WHERE BrojVaucera=?";
                        PreparedStatement evidentiraj = con.prepareStatement(upit);
                        evidentiraj.setString(1, brojVaucera);
                        evidentiraj.execute();
                        out.println("<h2 id=\"uspesno\">Status vaučera je promenjen u iskorišćen</h2>");
                        request.getRequestDispatcher("EvidentirajVaucer.jsp").include(request, response);
                        
                    }else{
                                out.println("<h2 id=\"greska\">Ne možete završtiti ovu aktivnost jer je odabrani vaučer istekao</h2> ");
                                request.getRequestDispatcher("EvidentirajVaucer.jsp").include(request, response);
                    }} else{
