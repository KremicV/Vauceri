<%-- 
    Document   : PonistiVaucer
    Created on : Oct 14, 2022, 4:41:31 PM
    Author     : vlada
--%>
...
<html>
    <head>
        ...
        <title>Poništi vaučer</title>
        <div> <%-- GORNJA TRAKA --%>
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
           <div class="icon-bar">
               <h1>Poništi vaučer</h1>
        </div>
    </head>
    <body bgcolor="#FFF1D0">
        <style>
            .icon-bar {
             ...
             .icon-bar a {
               ...
               #submitPonisti:hover, #meni:hover{
        ...
        <%-- POCETAK SESIJE  --%>
         <%  
           ...
           %> <h3> <%=name %> </h3> 
            ...
            <form action="Ponisti" method="post">
               <label for="brojVaucera">Broj vaučera:   </label>
               <input type="text" name="brojVaucera"><br>
               <input type="submit" value="Poništi vaučer" id="submitPonisti">
            </form> <br><br>
